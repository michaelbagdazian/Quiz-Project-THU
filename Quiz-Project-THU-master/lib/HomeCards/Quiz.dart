        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(width: 435,
                ...
                child: IconButton(
                  onPressed: () => selectedItem(context, 'myQuizes'),//<- here you can change the destination of the card
                  icon: Image.asset("assets/images/Quiz2.png"), // <- immage of the card
                ),
              ),
