...
class ManualQuizeCreation {
  Quiz createTestQuiz(
    ...
    Map<String, bool> answers_1 = <String, bool>{};
    ...
    Map<String, bool> answers_2 = <String, bool>{};
    ...
    Map<String, bool> answers_3 = <String, bool>{};
    ...
    Map<String, bool> answers_4 = <String, bool>{};
    ...
    Map<String, bool> answers_5 = <String, bool>{};
