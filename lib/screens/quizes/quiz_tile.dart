...
class QuizTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushReplacementNamed(context, '/quizWrapper',
          arguments: {'quiz': quiz}), //<- here logic when your click the tile
      child: Card(
                ...
                children: [
                  ...
                  WidgetSpan(
                    child: Icon(Icons.group,
                        color: quiz.quizIsShared ? right : wrong),
                  ),
                ],
              ),
            ),
              ...
              Center(
                child: Padding(
                  ...
                  child: Align(
                    ...
                    //text content
                    child: Text(quiz.quizDescription,
                        style:
